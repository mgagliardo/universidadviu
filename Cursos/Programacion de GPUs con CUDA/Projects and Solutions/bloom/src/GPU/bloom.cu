...
cudaError_t insertWordsPBF(char* dev_bloom,int size,char* words,
	...
	insertWordsGpuPBF<<<blockDimensions,threadDimensions>>>(dev_bloom,size,dev_words,dev_offsets,numWords,numHashes,numRowPerHash,prob,randOffset);
...
cudaError_t queryWordsPBF(char* dev_bloom,int size,char* words,
	...
	queryWordsGpuPBF<<<blockDimensions,threadDimensions>>>(dev_bloom,size,dev_words,dev_offsets,dev_results,numWords,numHashes,numRowPerHash);
	cudaThreadSynchronize();
